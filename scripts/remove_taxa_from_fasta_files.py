...
write fasta files without the taxa on a given list
...
def write_fasta(fasta_DIR, fasta_file_ending, taxa_to_remove_file, outDIR):
...
if __name__ == "__main__":
	if len(sys.argv) != 5:
		print "python remove_taxa_from_fasta_files_complete_taxa.py inDIR fasta_file_ending taxa_to_remove_txt_file outDIR"
		sys.exit(0)

	fasta_DIR, fasta_file_ending, taxa_to_remove_file, outDIR  = sys.argv[1:]
	write_fasta(fasta_DIR, fasta_file_ending, taxa_to_remove_file, outDIR)
